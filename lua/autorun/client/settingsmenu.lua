function OpenMenu()
	...
	damageConfig.DoClick = function(damageConfig)
		...
		nSlider1:SetMax(100)
		nSlider1:SetTooltip("Determines how much health SPV3 units have.")
		nSlider1:SetSize(Frame:GetWide()*.9, 20)
		nSlider1:SetPos(Frame:GetWide()*.05, 30)
		...
		nSlider2:SetMax(100)
		nSlider2:SetSize(Frame:GetWide()*.9, 20)
		nSlider2:SetTooltip("Determines how much shields SPV3 units would have. Also effects marine armor.")
		nSlider2:SetPos(Frame:GetWide()*.05, 60)
		...
		nSlider3:SetSize(Frame:GetWide()*.9, 20)
		nSlider3:SetPos(Frame:GetWide()*.05, 90)
		nSlider3:SetTooltip("Determines how much damage SPV3 npcs deal.")
		...
		nSlider4:SetTooltip("Determines how much damage SPV3 npcs take from other NPCs. Useful if you want them to take the same damage from players but different from other NPCs.")
		...
		local nSlider5 = vgui.Create("DNumSlider", Frame)
		nSlider5:SetText("Precision Dmg Threshold")
		nSlider5:SetMin(0)
		nSlider5:SetMax(1000)
		nSlider5:SetSize(Frame:GetWide()*.9, 20)
		nSlider5:SetPos(Frame:GetWide()*.05, 150)
		nSlider5:SetTooltip("Determines how much damage a bullet needs to do in order to be considered a headshot")
		nSlider5:SetConVar("vj_spv3_PrecisionThreshold")
		nSlider5:SetDefaultValue(GetConVar("vj_spv3_PrecisionThreshold"):GetFloat())

		local x, y = nSlider5:GetPos()
	...
	miscConfig.DoClick = function(miscConfig)
		...
		local nSliderUWep = vgui.Create("DNumSlider", Frame)
		nSliderUWep:SetText("Chance Covenant spawn with UNSC weapons.")
		nSliderUWep:SetMin(0)
		nSliderUWep:SetMax(100)
		nSliderUWep:SetSize(Frame:GetWide()*.9, 20)
		nSliderUWep:SetPos(Frame:GetWide()*.05, 60)
		nSliderUWep:SetConVar("vj_spv3_CovenantExtraWeaponChance")
		nSliderUWep:SetTooltip("What are the chances a Covenant unit will spawn with a UNSC weapon?")

		local nSliderCWep = vgui.Create("DNumSlider", Frame)
		nSliderCWep:SetText("Chance UNSC spawn with Covenant weapons.")
		nSliderCWep:SetMin(0)
		nSliderCWep:SetMax(100)
		nSliderCWep:SetSize(Frame:GetWide()*.9, 20)
		nSliderCWep:SetPos(Frame:GetWide()*.05, 90)
		nSliderCWep:SetConVar("vj_spv3_UNSCExtraWeaponChance")
		nSliderCWep:SetTooltip("What are the chances a UNSC unit will spawn with a Covenant weapon?")

		local nSliderFWep = vgui.Create("DNumSlider", Frame)
		nSliderFWep:SetText("Chance Flood spawn with weapons.")
		nSliderFWep:SetMin(0)
		nSliderFWep:SetMax(100)
		nSliderFWep:SetSize(Frame:GetWide()*.9, 20)
		nSliderFWep:SetPos(Frame:GetWide()*.05, 120)
		nSliderFWep:SetConVar("vj_spv3_FloodExtraWeaponChance")
		nSliderFWep:SetTooltip("What are the chances a Combat Form unit will spawn with a weapon?")
		...
		Frame:SetSize(600, y + 30)
		Frame:Center()
	end
	local resetEverything = vgui.Create("DButton", allS)
	resetEverything:SetFont("DermaDefaultBold")
	resetEverything:SetText("Reset settings")
	resetEverything:SetSize(200,25)
	resetEverything:SetPos(allS:GetWide()*.3, 200)
	resetEverything:CenterHorizontal(0.5)
	resetEverything:SetColor(Color(255,0,0,255))
	resetEverything.DoClick = function(resetEverything)
		LocalPlayer():ConCommand("vj_spv3_DamageModifier 0.5")
		LocalPlayer():ConCommand("vj_spv3_NPCTakeDamageModifier 2")
		LocalPlayer():ConCommand("vj_spv3_HealthModifier 1")
		LocalPlayer():ConCommand("vj_spv3_ShieldModifier 1")
		LocalPlayer():ConCommand("vj_spv3_PrecisionThreshold 15.1")
		LocalPlayer():ConCommand("vj_spv3_infModifier 1")
		LocalPlayer():ConCommand("vj_spv3_floodOption infect_onlyHalo")
		LocalPlayer():ConCommand("vj_spv3_ffretal 1")
		LocalPlayer():ConCommand("vj_spv3_bonusInfForms 1")
		LocalPlayer():ConCommand("vj_spv3_InfFormsExplode 1")
		LocalPlayer():ConCommand("vj_spv3_CovenantExtraWeaponChance 0")
		LocalPlayer():ConCommand("vj_spv3_UNSCExtraWeaponChance 0")
		LocalPlayer():ConCommand("vj_spv3_FloodExtraWeaponChance 30")
		LocalPlayer():ConCommand("vj_spv3_phantomAssistTime 20")
		LocalPlayer():ConCommand("vj_spv3_phantomSpawns 0 ")
		LocalPlayer():ConCommand("vj_spv3_phantomMinReinfStr 35")
		LocalPlayer():ConCommand("vj_spv3_phantomMaxReinfStr 45")
		LocalPlayer():ConCommand("vj_spv3_phantomMinUnitStr 1")
		LocalPlayer():ConCommand("vj_spv3_phantomMaxUnitStr 15")
		LocalPlayer():ConCommand("vj_spv3_biomassSpread 3")
		LocalPlayer():ConCommand("vj_spv3_mapCov 100")
		LocalPlayer():ConCommand("vj_spv3_mapUNSC 100")
		LocalPlayer():ConCommand("vj_spv3_mapFlood 100")
		LocalPlayer():ConCommand("vj_spv3_mapLimit 80")
		LocalPlayer():ConCommand("vj_spv3_dropGrenades 1")
	end
end
