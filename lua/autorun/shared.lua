...
function OpenMenu()
	...
	miscConfig.DoClick = function(miscConfig)
		...
		nSliderFWep:SetTooltip("What are the chances a flood that spawns will spawn with a weapon as well?")
	...
	resetEverything.DoClick = function(resetEverything)
		LocalPlayer():ConCommand("vj_spv3_DamageModifier 1")
		...
		LocalPlayer():ConCommand("vj_spv3_floodWeps 30")
		LocalPlayer():ConCommand("vj_spv3_floodEliteShield 30")
