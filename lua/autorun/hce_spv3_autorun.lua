...
if VJExists == true then
	...
	-- Weapons
	VJ.AddWeapon("[SPV3] (Cov) Plasma Rifle", "weapon_vj_cov_spv3_plasmarifle", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Brute Plasma Rifle", "weapon_vj_cov_spv3_plasmarifleBrute", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Plasma Pistol", "weapon_vj_cov_spv3_plasmapistol", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Brute Plasma Pistol", "weapon_vj_cov_spv3_plasmapistolBrute", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Bruteshot", "weapon_vj_cov_spv3_bruteshot", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Focus Rifle", "weapon_vj_cov_spv3_focusrifle", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Particle Carbine", "weapon_vj_cov_spv3_particleCarbine", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Piercer", "weapon_vj_cov_spv3_piercer", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Shredder", "weapon_vj_cov_spv3_shredder", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Needler", "weapon_vj_cov_spv3_needler", false, vCat)
	VJ.AddWeapon("[SPV3] (Cov) Energy Sword", "weapon_vj_cov_spv3_energysword", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Assault Rifle", "weapon_vj_unsc_spv3_ar", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Battle Rifle", "weapon_vj_unsc_spv3_br", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Designated Marksman Rifle", "weapon_vj_unsc_spv3_dmr", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Sniper Rifle", "weapon_vj_unsc_spv3_sr", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Shotgun", "weapon_vj_unsc_spv3_sg", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Rocket Launcher", "weapon_vj_unsc_spv3_rl", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) SMG", "weapon_vj_unsc_spv3_smg", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) SMGSD", "weapon_vj_unsc_spv3_smgsd", false, vCat)
	VJ.AddWeapon("[SPV3] (UNSC) Magnum", "weapon_vj_unsc_spv3_magnum", false, vCat)
