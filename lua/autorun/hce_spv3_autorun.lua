...
if VJExists == true then
	...
	VJ.AddCategoryInfo("Halo CE SPV3", {Icon = "icons/spv3_icon.png"})
	...
	-- Weapons
	VJ.AddWeapon("SPV3 Plasma Rifle", "weapon_vj_cov_spv3_plasmarifle", false, vCat)
	VJ.AddWeapon("SPV3 Brute Plasma Rifle", "weapon_vj_cov_spv3_plasmariflebrute", false, vCat)
	VJ.AddWeapon("SPV3 Plasma Pistol", "weapon_vj_cov_spv3_plasmapistol", false, vCat)
	VJ.AddWeapon("SPV3 Brute Plasma Pistol", "weapon_vj_cov_spv3_plasmapistolbrute", false, vCat)
	VJ.AddWeapon("SPV3 Bruteshot", "weapon_vj_cov_spv3_bruteshot", false, vCat)
	VJ.AddWeapon("SPV3 Focus Rifle", "weapon_vj_cov_spv3_focusrifle", false, vCat)
	VJ.AddWeapon("SPV3 Particle Carbine", "weapon_vj_cov_spv3_particlecarbine", false, vCat)
	VJ.AddWeapon("SPV3 Piercer", "weapon_vj_cov_spv3_piercer", false, vCat)
	VJ.AddWeapon("SPV3 Shredder", "weapon_vj_cov_spv3_shredder", false, vCat)
	VJ.AddWeapon("SPV3 Needler", "weapon_vj_cov_spv3_needler", false, vCat)
	VJ.AddWeapon("SPV3 Energy Sword", "weapon_vj_cov_spv3_energysword", false, vCat)
	VJ.AddWeapon("SPV3 Assault Rifle", "weapon_vj_unsc_spv3_ar", false, vCat)
	VJ.AddWeapon("SPV3 Battle Rifle", "weapon_vj_unsc_spv3_br", false, vCat)
	VJ.AddWeapon("SPV3 Designated Marksman Rifle", "weapon_vj_unsc_spv3_dmr", false, vCat)
	VJ.AddWeapon("SPV3 Sniper Rifle", "weapon_vj_unsc_spv3_sr", false, vCat)
	VJ.AddWeapon("SPV3 Shotgun", "weapon_vj_unsc_spv3_sg", false, vCat)
	VJ.AddWeapon("SPV3 Rocket Launcher", "weapon_vj_unsc_spv3_rl", false, vCat)
	VJ.AddWeapon("SPV3 SMG", "weapon_vj_unsc_spv3_smg", false, vCat)
	VJ.AddWeapon("SPV3 SMGSD", "weapon_vj_unsc_spv3_smgsd", false, vCat)
	VJ.AddWeapon("SPV3 Magnum", "weapon_vj_unsc_spv3_magnum", false, vCat)
	VJ.AddWeapon("SPV3 Plasma Grenade","weapon_vj_cov_spv3_plasma_nade", false, vCat)
	VJ.AddWeapon("SPV3 Cluster Grenade","weapon_vj_cov_spv3_cluster_nade", false, vCat)
	VJ.AddWeapon("SPV3 Gravity Grenade","weapon_vj_cov_spv3_gravity_nade", false, vCat)
	VJ.AddWeapon("SPV3 Needler Grenade","weapon_vj_cov_spv3_needler_nade", false, vCat)
	VJ.AddWeapon("SPV3 Frag Grenade","weapon_vj_unsc_spv3_frag_nade", false, vCat)
