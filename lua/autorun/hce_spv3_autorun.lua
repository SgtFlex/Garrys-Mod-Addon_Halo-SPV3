...
if VJExists == true then
	...
	VJ.AddNPC_HUMAN("[Cov] Elite Ultra","npc_vj_halo_cov_spv3_elite_ult",{"weapon_vj_cov_spv3_plasmarifle"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite Zealot","npc_vj_halo_cov_spv3_elite_zel",{"weapon_vj_cov_spv3_plasmarifle","weapon_vj_cov_spv3_needler"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite Ossoona","npc_vj_halo_cov_spv3_elite_oss",{"weapon_vj_cov_spv3_plasmarifle","weapon_vj_cov_spv3_needler"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite Spec-Ops","npc_vj_halo_cov_spv3_elite_spc",{"weapon_vj_cov_spv3_plasmarifle","weapon_vj_cov_spv3_needler"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite HG Minor","npc_vj_halo_cov_spv3_elite_hg_min",{"weapon_vj_cov_spv3_plasmarifle"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite HG Major","npc_vj_halo_cov_spv3_elite_hg_maj",{"weapon_vj_cov_spv3_plasmarifle"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite HG Ultra","npc_vj_halo_cov_spv3_elite_hg_ult",{"weapon_vj_cov_spv3_plasmarifle"},vCat)
	VJ.AddNPC_HUMAN("[Cov] Elite HG Zealot","npc_vj_halo_cov_spv3_elite_hg_zel",{"weapon_vj_cov_spv3_plasmarifle"},vCat)
