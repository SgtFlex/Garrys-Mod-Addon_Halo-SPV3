...
SWEP.Primary.Sound				= {"weapons/sniper rifle/fire/sniperC.wav"}
SWEP.ReloadSound 				= {"weapons/sniper rifle/reload/reload_full_1.wav", "weapons/sniper rifle/reload/reload_full_2.wav"}
