...
SWEP.PrintName					= "SPV3 Plasma Pistol"
SWEP.Author = "SgtFlex"
...
SWEP.NPC_SecondaryFireEnt = "obj_vj_spv3_pp_charged" -- The entity to fire, this only applies if self:NPC_SecondaryFire() has NOT been overridden!
