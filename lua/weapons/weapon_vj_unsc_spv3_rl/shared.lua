...
SWEP.Primary.Sound				= {"weapons/rocket launcher/fire/fire_1.wav","weapons/rocket launcher/fire/fire_2.wav","weapons/rocket launcher/fire/fire_3.wav"}
SWEP.ReloadSound 				= {"weapons/rocket launcher/reload/rocket_reload.wav"}
