...
function ENT:CustomOnPhysicsCollide(data,phys)
	...
	if (self.DaddyNade==true) then
		for i=1,4 do
			local nadeSplit = ents.Create("obj_vj_spv3_cluster_nade")
			nadeSplit:SetPos(self:GetPos()))
			nadeSplit:SetVelocity(Vector(math.random(-100,100), math.random(-100,100), 50))
