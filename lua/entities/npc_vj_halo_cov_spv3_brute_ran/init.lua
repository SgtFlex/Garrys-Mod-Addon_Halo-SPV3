...
function ENT:SetPhysicalAppearance()
	...
	self:SetBodyGroups("0"..table.concat({math.random(0, 5), math.random(0, 2), math.random(0, 2), math.random(0, 1), math.random(0, 3), math.random(0, 3), math.random(0, 3), math.random(0, 1), math.random(0, 1)}))
